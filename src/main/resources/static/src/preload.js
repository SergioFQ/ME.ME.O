class Preload extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.audio('victoryloop', 'resources/audio/victoryloop.mp3');
    ...
    createLoadingBar() {
        // Title
        this.title = this.add.text(250, 300, 'Loading Game'
        , { fontFamily: 'Berlin Sans FB, "Goudy Bookletter 1911", Times, serif', fontSize: '28px', fill: '#fff' });/*new Text(
            this,
            400,
            300,
            'Loading Game',
        ...
        // Progress text
        this.txt_progress = this.add.text(450, 300, 'Loading...'
        , { fontFamily: 'Berlin Sans FB, "Goudy Bookletter 1911", Times, serif', fontSize: '28px', fill: '#fff' });/*new Text(
            this,
            400,
            410,
