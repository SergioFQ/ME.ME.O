class PlayerVictory extends Phaser.Scene {
    constructor()//para poder llamar a la escena desde otras escenas
    {
        super({ key: 'PlayerVictory', active: false });
    }
    ...
    create() {
        ...
        this.text = this.add.text(400, 250, 'Player ' + (this.player + 1) + ' wins', { fontFamily: 'Berlin Sans FB, "Goudy Bookletter 1911", Times, serif', fontSize: '48px', fill: '#fff' });
