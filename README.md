...
Respecto a la fase 2 del desarrollo del juego, hemos implementado mediante Api Rest una lobby en la que los jugadores podrán escribir en un chat, conocer su estado, el del servidor y su rival, elegir personaje y ver éste y el de su rival en partida. A pesar de aparecer ambos personajes en partida, no podrán moverse porque eso se realizará en la próxima fase.
...
+ **Escena de victoria**: Escena final del juego. En ella podemos ver el nombre del vencedor (Player 1 o Player 2) y un efecto cómico hecho con la cabeza del vencedor. Desde aquí se puede ir al menú principal mediante el botón "MENU"
...
- **Escena partida Online**: los jugadores se encontrarán con el escenario de la partida sin funcionalidad (ésta será implementada en la fase siguiente) pero con los personajes seleccionados por cada uno. Además de ver a los personajes seleccionados, los jugadores podrán ver el estado de cada jugador en la parte superior de la pantalla y su nombre y el de su rival encima de los personajes seleccionados. En caso de que los jugadores lo deseen, podrán volver al menú principal haciendo click en el botón de Menu en la esquina inferior izquierda. Asimismo, se podrá ir a la escena notificaciones cuando el servidor se cierre, el rival se vaya (debido a la naturaleza del juego, no tendría sentido quedarse solo uno en partida), cuando estuviese AFK el jugador o cuando el ping fuese demasiado alto.

![](https://github.com/SergioFQ/ME.ME.O/blob/main/ReadmeImages/gameOnline.PNG)
